...
% ============================================================
\begin{abstract}
Computing $(a\,b)\bmod p$ across primes has a wall: monolithic learners fit the
primes they train on and transfer near zero to primes they did not see
\citep{lauter2024modular} in the sequence-length and architecture regimes they
study. NeuralHorner clears that wall across all ten tiers of the challenge's
...
reads the whole operand pair and emits the whole product fits the primes it trains
on and transfers near $0\%$ to primes it did not see \citep{lauter2024modular}; the
...
monolithic framing yields effectively no cross-prime transfer, the conditioned
...
monolithic learners report near-zero transfer. This is an application of existing
...
a sequence-to-sequence transformer and report that monolithic learners do not
transfer across primes, with cross-prime accuracy near zero. The monolithic
...
the monolithic framing of \citet{lauter2024modular} yields effectively none. The
...
the near-zero cross-prime transfer reported by \citet{lauter2024modular}; the
...
their training primes and transfer near zero to unseen ones. A single
