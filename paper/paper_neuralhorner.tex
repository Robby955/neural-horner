...
end to end, is the premise of neural algorithmic reasoning \citep{velickovic2021nar};
relatedly, transformers length-generalize on a task when it admits a short program in
a transformer-expressible language \citep{zhou2023rasp}. Fixing the Horner schedule
...
transformers on modular arithmetic inside lattice attacks \citep{salsa2022}. The
