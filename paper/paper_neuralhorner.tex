...
gate on the scored tiers, is the principled follow-up --- in progress, not a settled
fix.
...
A reader should not read $1.00$ on the scorer as exactness. Counterexample-driven
