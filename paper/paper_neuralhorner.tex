...
Both fixes we tried shared a gap: the on-policy harvest and the regression gate covered
the Fermat and scored-tier distributions but not the other adversarial families, so it
is unsurprising those drifted. Whether jointly harvesting and gating on all families at
once removes the residual, or whether it is a fixed capacity budget that any targeted
fix only relocates, is open and untested here.
